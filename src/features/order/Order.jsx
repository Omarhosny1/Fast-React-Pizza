...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <div className="flex flex-col gap-4 bg-stone-200 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1 border-b-2 border-stone-300 p-4">
